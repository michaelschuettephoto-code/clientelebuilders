        ...
        <div className="ia-page">
          <div className="ia-two-col">
              ...
              <div className="ia-opp-grid">
                <div className="ia-opp-box ia-gold">
                  ...
                  <div className="ia-opp-body">
                    ...
                    — it's a funnel with measurable stages. They optimize it like
                    a business, not a hope.
                  </div>
                </div>
                <div className="ia-opp-box ia-sky">
                  ...
                  <div className="ia-opp-body">
                    ...
                    milestones for week one, month one, month three. New agents
                    don't figure it out — they follow a system that was built
                    before they arrived.
                  </div>
                </div>
                <div className="ia-opp-box ia-green">
                  ...
                  <div className="ia-opp-body">
                    ...
                    Instead of reinventing every quarter, they execute. The
                    business runs on repeatable infrastructure — not on whoever
                    showed up today.
                  </div>
                </div>
                <div className="ia-opp-box ia-slate">
                  ...
                  <div className="ia-opp-body">
                    ...
                    creates a crisis. Consistent growth comes from consistent
                    systems, not lucky months.
                  </div>
                </div>
              </div>
            ...
            <div className="ia-sidebar">
              ...
              <div className="cta-box" style={{ background: "hsl(37, 66%, 47%)", padding: "20px 16px", textAlign: "center" }}>
                <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "15px", fontWeight: 700, color: "#0D1B2A", marginBottom: "10px", lineHeight: 1.3 }}>
